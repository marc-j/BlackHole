...
SECRET_KEY = '+#xzgsn5-nlhkcec6mr$8u2ag-1$+zrx^e$fflj9qh^hy$cy##'
...
#To enable radius auth, complete the information an uncomment the AUTHENTICATION_BACKENDS line
...
LOGIN_URL = '/blackhole/login/'
LOGOUT_URL = '/blackhole/logout/'
LOGIN_REDIRECT_URL = '/blackhole/index/'
